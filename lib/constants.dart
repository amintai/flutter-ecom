...
List<Product> products = [
  Product(
      ...
      image: "assests/images/bag_1.png",
  ...
  Product(
      ...
      size: 8,
      description: dummyText,
      image: "assests/images/bag_2.png",
  ...
  Product(
      ...
      size: 10,
      description: dummyText,
      image: "assests/images/bag_3.png",
  ...
  Product(
      ...
      size: 11,
      description: dummyText,
      image: "assests/images/bag_4.png",
  ...
  Product(
      ...
      size: 12,
      description: dummyText,
      image: "assests/images/bag_5.png",
  ...
  Product(
    ...
    size: 12,
    description: dummyText,
    image: "assests/images/bag_6.png",
